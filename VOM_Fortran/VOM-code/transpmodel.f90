...
!     * Definition of variable parameters
      ...
      namelist /inputpar/ i_alpha, i_cpccf, i_tcft,i_tcfg, i_maxyear,  &
...
!     * Reading hourly climate data if available
     ...
     &                            STATUS='old', IOSTAT=stat)
        ...
        oldh = 99
        do i = 1, c_maxhour
          read(kfile_hourlyweather,'(5i8,6e11.3)') h, dummyint1,       &
...
!*-----Calculation of derived parameters--------------------------------
     ...
     &    'fmonth', 'fyear', 'tair_h', 'vd_h', 'par_h', 'rain_h', 'press_h','ca_h'
      endif
